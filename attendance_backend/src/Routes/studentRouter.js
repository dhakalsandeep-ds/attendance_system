...
import { attendanceDetail, loginStudent, logoutStudent, showEnrolledClasses, studentDetail, updatePasswordStudent } from "../controllers/studentController.js";
...
studentRouter.route("/update-password").post(isAuthenticated,isAuthorizedStudent,updatePasswordStudent)
