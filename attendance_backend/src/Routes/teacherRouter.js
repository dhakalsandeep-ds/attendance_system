...
import { loginTeacher, logoutTeacher, showAllBatch, updatePasswordTeacher} from "../controllers/teacherController.js";
...
teacherRouter.route("/update-password").post(isAuthenticated,isAuthorizedTeacher,updatePasswordTeacher)
